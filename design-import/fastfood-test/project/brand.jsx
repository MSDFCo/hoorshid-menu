...
function GoldLogo({ width, shine = null, glow = 0.6 }) {
  ...
  const mask = {
    WebkitMaskImage: 'url(assets/logo_gold.png)', maskImage: 'url(assets/logo_gold.png)',
  ...
  return (
    <div style={{
      ...
      <img src="assets/logo_gold.png" alt="هورشید"
...
const PRODUCTS = [
  { id: 'american', img: 'assets/american.png', name: 'پیتزا آمریکایی', variant: 'spin', price: 'از ۵۷۰٬۰۰۰ تومان',
    items: ['رست بیف', 'مرغ و قارچ', 'پپرونی', 'مخصوص', 'پپرونی و گوشت ویژه', 'مخصوص ارگانیک', 'تورکی برست', 'تورکی رونی'],
    accent: ['#7FB04A', '#E8C15A', '#C8862B'] },
  { id: 'italian',  img: 'assets/italian.png',  name: 'پیتزا ایتالیایی', variant: 'slideRight', price: 'از ۵۸۰٬۰۰۰ تومان',
    items: ['رست بیف', 'مرغ و قارچ', 'پپرونی', 'مخصوص', 'ارگانیک', 'تورکی برست'],
    accent: ['#C44536', '#7FB04A', '#E8C15A'] },
  { id: 'baalbaki', img: 'assets/baalbaki.png', name: 'پیتزا بعلبکی لبنانی', variant: 'dropBounce', price: 'از ۶۲۵٬۰۰۰ تومان', imgScale: 0.94, imgYAdjust: 26,
    items: ['گوشت', 'میکس', 'مرغ', 'بوقلمون', 'مخصوص', 'پپرونی', 'مخصوص ارگانیک'],
    accent: ['#E8C15A', '#C8862B', '#9A5B2A'] },
  { id: 'burger',   img: 'assets/burger.png',   name: 'برگر', variant: 'smoke', price: 'از ۳۹۵٬۰۰۰ تومان',
    items: ['برگر ذغالی', 'چیزبرگر', 'ماشروم برگر', 'بانی برگر', 'میکس برگر'],
    accent: ['#C8862B', '#E8C15A', '#C44536'] },
  { id: 'grilled',  img: 'assets/grilled.png',  name: 'ساندویچ گریل', variant: 'flyLeft', price: 'از ۳۹۰٬۰۰۰ تومان',
    items: ['رست بیف', 'مرغ', 'پپرونی', 'مخصوص'],
    accent: ['#C8862B', '#E8C15A', '#7FB04A'] },
  { id: 'sandwich', img: 'assets/sandwich.png', name: 'ساندویچ', variant: 'popSpark', price: 'از ۲۹۰٬۰۰۰ تومان',
    items: ['مرغ', 'رست بیف', 'ژامبون میکس سرد', 'هات داگ'],
    accent: ['#C44536', '#E8C15A', '#C8862B'] },
  { id: 'snack',    img: 'assets/snack.png',    name: 'اسنک', variant: 'slideRight', price: 'از ۲۶۰٬۰۰۰ تومان',
    items: ['گوشت', 'مرغ', 'پپرونی', 'مخصوص', 'مخصوص ارگانیک'],
    accent: ['#E8C15A', '#7FB04A', '#F4A82E'] },
  { id: 'appetizer',img: 'assets/appetizer.png',name: 'پیش غذا', variant: 'smoke', price: 'از ۲۳۰٬۰۰۰ تومان',
